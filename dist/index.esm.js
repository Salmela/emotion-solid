...
let EmotionCacheContext = /* #__PURE__ */createContext( // we're doing this to avoid preconstruct's dead code elimination in this one case
...
const _tmpl$ = template(`<style></style>`, 2);
    ...
    const Styled = withEmotionCache((props, cache) => {
      ...
      const getClassNameAndRegisteredStyles = createMemo(() => {
        if (typeof props.className === 'string') {
          ...
          const className = getRegisteredStyles(cache === null || cache === void 0 ? void 0 : cache.registered, classInterpolations, props.className);
          return [className, cache === null || cache === void 0 ? void 0 : cache.registered];
      ...
      const newProps = mergeProps(props); // for (let key in props) {

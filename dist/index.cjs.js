...
let EmotionCacheContext = /* #__PURE__ */solidJs.createContext( // we're doing this to avoid preconstruct's dead code elimination in this one case
...
let withEmotionCache = function withEmotionCache(func) {
  return props => {
    ...
    let cache = solidJs.useContext(EmotionCacheContext);
  ...
  withEmotionCache = function withEmotionCache(func) {
    return props => {
      ...
      if (cache === null) {
        ...
        return (// @ts-ignore
          web.createComponent(EmotionCacheContext.Provider, {
            value: cache,
...
const _tmpl$ = web.template(`<style></style>`, 2);
...
const createStyled = (tag, options) => {
  ...
  return function (...args) {
    ...
    const Styled = withEmotionCache((props, cache) => {
      ...
      const getClassNameAndRegisteredStyles = solidJs.createMemo(() => {
      ...
      const getRules = solidJs.createMemo(() => {
        let mergedProps = solidJs.mergeProps(props, {
          get theme() {
            return useTheme();
          }
      ...
      const newProps = solidJs.mergeProps(props); // for (let key in props) {
